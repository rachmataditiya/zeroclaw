...
pub use schema::{
    ...
    IMessageConfig, IdentityConfig, LangExecConfig, LarkConfig, LoggingConfig, MatrixConfig,
    McpConfig, McpServerConfig, McpTransportType, MemoryConfig, ModelRouteConfig,
